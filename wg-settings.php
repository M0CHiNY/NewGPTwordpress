    ...
    <div class="container">
        ...
        <div class="settings__wrap" style="background-image: url('<?= imgPath('bg.jpg')?>')">
            ...
            <div class="settings__inner">
                <form class="settings__form" method="POST"><label class="settings__label" for="">Chat GPT <input class="settings__input setting__api" name="apiToken" placeholder="API Token (sk-xxxxx)"  value="<?= $settings->getTableData()[0]->api_token ?? ''?>" required></label> <label class="settings__label settings__label--hidden" for="">
